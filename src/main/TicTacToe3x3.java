...
public class TicTacToe3x3 implements Game {
	...
	/*
	 * returns an ArrayList of strings that can be used to make boards for the next turn
	 * Throws an error if the character is not an X or O
	 */
	@Override
	...
	/*
	 * checks whether a game has been won by either player
	 * if neither player has won then a check for a stalemate is initiated
	 */
	@Override
	...
	/*
	 * A sub-method of checkVictoryStatus that checks and updates the stalemate status of a game
	 * if a game does not yet have a winner it is possible the game is in a stalemate and no one won
	 * it does not check for impossibility of a winner so a game in which a winner cannot be attained will proceed till all nine squares are full
	 */
	@Override
	...
	public String toString() {
		/*
		 * This long return statement formats the TicTacToe board so it looks a standard one might draw on a piece of paper
		 * it checks each character to ensure that any e's are turned into empty spaces in order to increase readability
		 * it would turn XOeOOeeeX into
		 * X | O |  
		 * ---------
		 * O | O |  
		 * ---------
		 *   |   | X
		 */
		return ((this.board.charAt(0)!='e')?this.board.charAt(0):" ")+" | "+((this.board.charAt(1)!='e')?this.board.charAt(1):" ")+" | "+((this.board.charAt(2)!='e')?this.board.charAt(2):" ")+"\n"+"---------\n"+
				((this.board.charAt(3)!='e')?this.board.charAt(3):" ")+" | "+((this.board.charAt(4)!='e')?this.board.charAt(4):" ")+" | "+((this.board.charAt(5)!='e')?this.board.charAt(5):" ")+"\n"+"---------\n"+
				((this.board.charAt(6)!='e')?this.board.charAt(6):" ")+" | "+((this.board.charAt(7)!='e')?this.board.charAt(7):" ")+" | "+((this.board.charAt(8)!='e')?this.board.charAt(8):" ");
		//return this.board+"\n"+victoryStatus+"\n"+stalemateStatus+"";
	}
